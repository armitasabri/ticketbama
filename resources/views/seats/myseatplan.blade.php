...
<div class="container-fluid  pt-5" style="height:500px;">
        ...
        <div class="row d-flex ">
            <div class="col d-flex justify-content-center" style="padding-top:280px;">
                ...
                @if ($seat->status_id==3)
                    <div class="target " id="{{$seat->seat_no}}"    style="height:30px;width:30px;margin-left:20px;padding:5px;border:solid 2px black">{{$seat->seat_no}}
                        </div>
                @elseif($seat->status_id==1)
                <div class="target selected" id="{{$seat->seat_no}}"    style="height:30px;width:30px;margin-left:20px;padding:5px;border:solid 2px black">{{$seat->seat_no}}</div>
