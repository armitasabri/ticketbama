        ...
        <div class="row mt-3 d-flex ">
            ...
            <div class="col-4 border shadow" style="height: 300px;">
                <p style="font-size: 24px;" dir="rtl" align="right"><i class="zmdi zmdi-triangle-down"
                        ...
                        <p  style="font-size: 18px;padding-top:20px" dir="rtl" align="right"><i class="zmdi zmdi-triangle-down"
                        style="margin-left: 7px;color:#df42b1;"></i>زمان: {{$event->duration_minute}} دقیقه</p>
            </div>
        <div class="col-1"></div>
            <!-- event images -->
