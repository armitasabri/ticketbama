          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex ">
                   ...
                   <div><p style="padding-right:4px;">همین حالا یک گیشه جدید ثبت کن!</p>
                       </div> 
                </div>
                
            <form method="POST" action="{{route('admin_save_box_office')}}"   enctype="multipart/form-data">
                {{ csrf_field() }}<div class="form-group">
                    ...
                    <div class="form-group">
                        <label>رول</label>
                        <select disabled  id="roles" name="roles" value="" class="form-control">
