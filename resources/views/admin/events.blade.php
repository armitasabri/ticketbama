    ...
    <thead>
     ...
     {{-- {{dd($comment->user->)}} --}}
            ...
            @endforeach
             ...
             <td><img src="../storage/{{$event->fileimage}}" alt="" style="height:100px;width:100px"></td>
             {{-- <td>{{$event->created_at}}</td>
             <td>{{$event->updated_at}}</td> --}}
             <td>
                <div class="text-center">
                   <button type="button" name="edit" class="btn btn-warning ">Edit</button>
                <button type="button" name="delete" class="btn btn-danger mt-2">Delete</button>
                <button type="button" name="add" class="btn btn-success mt-2">Add</button>
