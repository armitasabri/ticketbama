<script src="{{asset('assets2/vendor/jquery/jquery.min.js')}}"></script>
    ...
    <script src="{{asset('assets2/js/grasp_mobile_progress_circle-1.0.0.min.js')}}"></script>
    ...
    <script src="{{asset('assets2/js/charts-home.js')}}"></script>
    <!-- Notifications-->
    <script src="{{asset('assets2/vendor/messenger-hubspot/build/js/messenger.min.js')}}">   </script>
    <script src="{{asset('assets2/vendor/messenger-hubspot/build/js/messenger-theme-flat.js')}}">       </script>
